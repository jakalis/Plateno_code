...
function BackButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-4 left-4 z-50 w-12 h-12 rounded-full bg-gray-200 text-gray-700 shadow-md hover:bg-gray-300 flex items-center justify-center transition-all"
      aria-label="Back"
    >
